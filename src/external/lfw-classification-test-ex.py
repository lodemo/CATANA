...
def plotAccuracy(workDir, largeFont,
                 openfaceCPUsvmDf, openfaceCPUlinearsvmDf, facenetlinearsvmDf):
    ...
    plt.bar(indices + 2 * barWidth, facenetlinearsvmDf['accsMean'], barWidth,
...
def plotTrainingTime(workDir, largeFont,
                     openfaceCPUsvmDf, openfaceCPUlinearsvmDf, facenetlinearsvmDf):
    indices = openfaceCPUsvmDf.index.values
    barWidth = 0.15
    ...
    plt.bar(indices + barWidth, openfaceCPUlinearsvmDf['trainTimeSecMean'], barWidth,
            ...
            color=colors[1], ecolor='0.3', alpha=alpha)
    plt.bar(indices + 2 * barWidth, facenetlinearsvmDf['trainTimeSecMean'], barWidth,
...
def plotPredictionTime(workDir, largeFont,
                       openfaceCPUsvmDf, openfaceCPUlinearsvmDf, facenetlinearsvmDf):
    indices = openfaceCPUsvmDf.index.values
    barWidth = 0.15
    ...
    plt.bar(indices + barWidth, openfaceCPUlinearsvmDf['predictTimeSecMean'], barWidth,
            ...
            label='OpenFace LinearSVC',
            color=colors[1], ecolor='0.3', alpha=alpha)
    plt.bar(indices + 2 * barWidth, facenetlinearsvmDf['predictTimeSecMean'], barWidth,
